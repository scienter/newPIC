...
/*
  case 3 :
    MPI_TransferP_Xplus(D,D->istart-1,D->iend+1,D->jstart,D->jend,D->kstart-1,D->kend+1);
    MPI_TransferP_Xminus(D,D->istart-1,D->iend+1,D->jstart,D->jend,D->kstart-1,D->kend+1);
    break;
*/
  default :
